...
class AccountController {
	...
	static navigation = [
		[group:"trackingTabs", action:"list", title:"Accounts", order:50],
		[group:"accountTabs", action:"list", title:"Account Home", order:0],
		[group:"accountTabs", action:"create", title:"Create Account", order:1],
